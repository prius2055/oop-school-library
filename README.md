...
**[oop-school-library]()** is a project that enables the creation of enumerables using classes, modules, instant variables and methods.
...
<ul>
    ...
    <li>run git clone "https://github.com/prius2055/oop-school-library.git"</li>
